...
const createRestaurantType = async(req, res) => {
    try {
        const data = await sequelize.query(
            'INSERT INTO "RestaurantType" ("businessId", "typeId")\
            VALUES (:businessId, :typeId)', {
                type:  QueryTypes.INSERT,
                replacements: {
...
const createRestaurantTables = async(req, res) => {
    try {
        const data = await sequelize.query(
            'INSERT INTO "RestaurantTable" ("tableId", "businessId")\
...
const getRestaurantReviewsById = async (req, res) => {
    try {
        const data = await sequelize.query(
            ...
            AND r."userId" = ru."userId" ORDER BY "usefulVotes" DESC', {
                type: QueryTypes.SELECT,
                replacements: {
                    businessId: req.params.businessId
                }
